...
class Dome:
    def __init__(self, config_file="dome_config.json"):
        ...
        if self.config.get("testing", {}).get("smoke_test", False):
            ...
            print("SMOKE TEST MODE: Using short timeout of {}s".format(self.MAX_OPEN_TIME))
        else:
            self.MAX_OPEN_TIME = (
    ...
    def wait_for_shutter_operation(self, operation_name):
        ...
        """
        print("Waiting {}s for {} to complete...".format(self.MAX_OPEN_TIME, operation_name))
        elapsed = 0
        ...
        self.shutter_stop()
        print(
            "{} operation completed (timed out at {}s)".format(operation_name, self.MAX_OPEN_TIME)
        )
