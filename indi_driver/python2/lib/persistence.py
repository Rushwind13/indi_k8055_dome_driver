...
class DomePersistence(object):
    ...
    def save_dome_state(self, dome, script_name=None):
        ...
        try:
            ...
            # Get current position - use attribute directly to avoid encoder recalculation
            try:
                # Use the stored position attribute, not get_pos() which recalculates from encoders
            ...
            print("Dome state saved: position={:.2f}°, home={}, turning={}, connected={}".format(
                current_position, state["is_home"], state["is_turning"], state["device_connected"]))
            return True
    ...
    def load_dome_state(self):
        ...
        try:
            ...
            print("Dome state loaded from {}: position={:.2f}°, saved by {}".format(
    ...
    def restore_dome_state(self, dome, state=None):
        ...
        try:
            ...
            print("Dome state restored: position={:.2f}°, home={}, turning={}, connected={}".format(
    ...
    def get_state_summary(self):
        ...
        summary.append("Position: {:.2f}°".format(state.get("position", 0.0)))
