...
class device:
    ...
    def disconnect(self):
        print("Diconnecting the device...", end="")
    ...
    def analog_all_in(self):
        ...
        print("Checking all analogue channels...", end="")
    ...
    def analog_all_clear(self):
        print("Clearing both analogue channels...", end="")
    ...
    def analog_all_out(self, data1, data2):
        print("Changing the value of both analogue channels...", end="")
    ...
    def digital_all_off(self):
        print("Turning all digital channels OFF...", end="")
    ...
    def digital_all_on(self):
        print("Turning all digital channels ON...", end="")
    ...
    def counter_reset(self, channel):
        print("Reseting Counter value...", end="")
